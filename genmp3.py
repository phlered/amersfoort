...
"""
        ...
        if langue_code == 'fr':  # Seulement pour le français
            ...
            if mots_cles_nl:
                yaml_header += f"mots_cles_nl: {mots_cles_nl}\n"
        yaml_header += "---\n\n"
...
def translate_to_dutch(french_text, target_lang):
    ...
    translations = {
        ...
        'Aller travailler en train': 'Met de trein naar het werk gaan',
        'American democracy': 'Amerikaanse democratie',
        'Au café': 'In het café',
        'Acheter des fruits': 'Fruit kopen',
        'Acheter un billet': 'Een kaartje kopen',
        'Célébrer': 'Vieren',
        'Changer de gare': 'Van station wisselen',
        'Décrire': 'Beschrijven',
        'Demander': 'Vragen',
        'Faire les courses': 'Boodschappen doen',
        'Histoire': 'Geschiedenis',
        'La météo': 'Het weer',
        'Les loisirs': 'Vrijetijdsactiviteiten',
        'Ma famille': 'Mijn familie',
        'Ma maison': 'Mijn huis',
        'Ma routine': 'Mijn routine',
        'Mon logement': 'Mijn woning',
        'Mon travail': 'Mijn werk',
        'Mes loisirs': 'Mijn vrijetijdsactiviteiten',
